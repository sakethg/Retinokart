...
* @author SAKETH G
*/
@WebServlet("/Addprduct")
public class Addprduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (isMultiPart) {
                ...
                stat = con.prepareStatement("insert into products(productname,price,offer,about,image,protype) values(?,?,?,?,?,?)");
